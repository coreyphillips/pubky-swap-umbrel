...
function writePhrase(text) {
  ...
  clearRecoveryFile();
  // A passphrase belongs to the identity it was set with. Carried onto a new one it does not
  // fail, it silently derives a third identity that is neither of the two the operator meant.
  clearPassphrase();
}
